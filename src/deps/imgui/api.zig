...
pub const internal = struct {
    ...
    pub fn debugNodeDrawCmdShowMeshAndBoundingBox(out_draw_list: *c.ImDrawList, draw_list: *const c.ImDrawList, draw_cmd: *const c.ImDrawCmd, show_mesh: bool, show_aabb: bool) void {
