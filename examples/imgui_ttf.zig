...
fn printTitle(text: [:0]const u8) void {
...
fn printContent(text: [:0]const u8) void {
...
fn loop(ctx: *zp.Context) void {
...

    {
        ...
        if (dig.begin("金刚经", null, 0)) {
            printTitle("金刚经 第一品 法会因由分");
            printContent(
                \\如是我闻。一时佛在舍卫国。祗树给孤独园。与大比丘众。千二百五十人俱。尔时世尊。食时。著衣持钵。入舍卫大城乞食。于其城中。次第乞已。还至本处。饭食讫。收衣钵。洗足已。敷座而坐。
            );
            printTitle("金刚经 第二品 善现启请分");
            printContent(
            ...
            printTitle("金刚经 第五品 如理实见分");
            printContent(
                \\须菩提。于意云何。可以身相见如来不。不也。世尊。不可以身相得见如来。何以故。如来所说身相。即非身相。佛告须菩提。凡所有相。皆是虚妄。若见诸相非相。即见如来。
            );
            printTitle("金刚经 第六品 正信希有分");
            printContent(
